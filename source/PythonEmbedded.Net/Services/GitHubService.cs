...
using GitHubReleaseDto = PythonEmbedded.Net.Models.GitHubReleaseDto;

namespace PythonEmbedded.Net.Services;

/// <summary>
/// Provides methods for interacting with GitHub releases, including finding releases,
/// extracting asset version information, downloading release assets, and listing available versions.
/// Optimized for specific use cases relevant to Python version management and embedded systems.
/// </summary>
public static class GitHubService
{
    ...
    private const string RepositoryApiUrl = $"{GitHubApiBaseUrl}/repos/{RepositoryOwner}/{RepositoryName}";
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            while (page <= maxPages)
            {
                var pageUrl = $"{RepositoryApiUrl}&page={page}";
